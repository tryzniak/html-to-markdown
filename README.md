...
```
go get github.com/tryzniak/html-to-markdown
```

## Usage

```go
import "github.com/tryzniak/html-to-markdown"
...
For all the possible options look at [godocs](https://godoc.org/github.com/tryzniak/html-to-markdown/#Options) and for a example look at the [example](/examples/options/main.go).
...
```go
import "github.com/tryzniak/html-to-markdown/plugin"
...
[Godoc](https://godoc.org/github.com/tryzniak/html-to-markdown)
